# sistema_cobro_ip_filtros



## Template variables

* `sistema_cobro_ip_filtros` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `sistema_cobro_ip_filtros` - executable or bundle name on disk.
* `sistema_cobro_ip_filtros` - display name shown in window titles and about app dialogs.
